...
public class ReagentAdminController {
    ...
    @ResponseBody
    public CommonResult<CommonPage<ReagentAdmin>> list(@RequestParam(value = "keyword", required = false) String keyword,
                                                   @RequestParam(value = "pageSize", defaultValue = "5") Integer pageSize,
                                                   @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum) {
        List<ReagentAdmin> adminList = adminService.list(keyword, pageSize, pageNum);
