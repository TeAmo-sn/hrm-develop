...
public class ReagentRoleController {
    ...
    @ResponseBody
    public CommonResult<CommonPage<ReagentRole>> list(@RequestParam(value = "keyword", required = false) String keyword,
                                                  @RequestParam(value = "pageSize", defaultValue = "5") Integer pageSize,
                                                  @RequestParam(value = "pageNum", defaultValue = "1") Integer pageNum) {
        List<ReagentRole> roleList = roleService.list(keyword, pageSize, pageNum);
